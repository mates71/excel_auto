...
public class AmazonDDT {
	...
	String excelPath = "./src/test/resources/TestData/amazonDDTDemo.xlsx";
	...
	public void searchTest() throws Exception {
		...
		for (int rownum = 1; rownum < rowCount; rownum++) {
			...
			if (execute.equalsIgnoreCase("N")) {
				...
				ExcelUtils.setCellData("Skiped", rownum, 3);
				continue;
			}
			...
			if (resultCount > 0) {
				...
				ExcelUtils.setCellData("passed", rownum, 3);
			} else {
				System.out.println("fail");
				ExcelUtils.setCellData("failed", rownum, 3);
			}
